...
지금까지 전략 성과를 볼 때 CAGR과 MDD 두 가지만 썼습니다. 오늘은 이 도구함을 제대로 채웁니다. 수익률 하나만 보고 전략을 고르는 것은 자동차를 최고 속도만 보고 고르는 것과 같습니다. 브레이크와 안전벨트를 함께 봐야 합니다. [퀀트 투자란 무엇인가](/posts/what-is-quant-investing/)에서 말한 "검증 가능성"이 실제로는 이 지표들을 본다는 뜻입니다.
