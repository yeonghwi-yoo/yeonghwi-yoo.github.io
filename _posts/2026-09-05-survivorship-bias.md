...
지난 글에서 "지금의 지수 구성종목으로 과거를 백테스트하면 안 된다"고 했습니다. 그 문제의 뿌리가 오늘 다룰 **생존 편향(survivorship bias)**입니다. 백테스트를 망가뜨리는 편향 중 가장 조용하고, 무료 데이터로 작업하는 개인 투자자가 가장 피하기 어려운 것이기도 합니다. [퀀트 투자란 무엇인가](/posts/what-is-quant-investing/)에서 "의심하는 습관"이라고 쓴 것의 구체적인 사례입니다.
