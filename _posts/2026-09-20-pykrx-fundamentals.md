...
마지막 줄의 이익수익률은 PER의 역수입니다. 다음 글에서 종목을 줄 세울 때 PER 대신 이걸 씁니다. 정렬 방향이 "클수록 싸다"로 직관과 맞고, 적자 종목은 결측으로 남겨 순위 맨 아래로 보내기 쉽습니다. (KRX는 적자 종목의 EPS 자체를 0으로 주기 때문에 손실의 크기는 알 수 없습니다. 이 점은 다음 글에서 다시 확인합니다.)
